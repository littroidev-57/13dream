export const initialBlogs = [
  {
    title: "Germany! The next big study abroad destination, here's the reason why!",
    slug: "germany-the-next-big-study-abroad-destination-heres-the-reason-why",
    excerpt: "Germany is rapidly becoming one of the most preferred destinations for international students due to tuition-free education at public universities and strong post-study career opportunities.",
    content: `<p>Germany has emerged as one of the premier study destinations for international students worldwide. With renowned technical universities, negligible tuition fees at public institutions, and generous post-study work visas of up to 18 months, Germany offers an unparalleled return on educational investment.</p>
    <p>International students benefit from state-of-the-art research laboratories, multicultural campus environments, and direct exposure to European industrial giants across automotive, renewable energy, and information technology sectors.</p>
    <p>At 13 Dreams Consultants, our certified advisors provide comprehensive guidance on APS certificate requirements, blocked account setup, University application portals (Uni-Assist), and German student visa applications with a high success track record.</p>`,
    image: "https://13dreamsconsultants.com/img/blog/Germany-The-next-big-study-abroad-destination-here-the-reason-why.webp",
    category: "Study in Germany",
    publishedAt: new Date("2023-06-14"),
  },
  {
    title: "Germany wants to make it easier for Indian IT workers to get work visa",
    slug: "germany-wants-to-make-it-easier-for-Indian-IT-workers-to-get-work-visa",
    excerpt: "The German government is modernizing immigration pathways, easing language requirements and salary thresholds for Indian IT specialists and engineers seeking work in Germany.",
    content: `<p>In a significant boost for Indian professionals and technology graduates, the German government has launched streamlined visa processes specifically aimed at addressing skilled labor shortages in IT, software development, and engineering disciplines.</p>
    <p>Key reforms include reduced minimum salary criteria for the EU Blue Card, accelerated recognition of Indian educational credentials, and allowances for candidates demonstrating practical experience even in lieu of traditional formal qualifications.</p>
    <p>Students pursuing STEM Master's degrees in Germany find themselves ideally situated to transition straight into full-time permanent residence trajectories under these updated frameworks.</p>`,
    image: "https://13dreamsconsultants.com/img/blog/Germany-wants-to-make-it-easier-for-Indian-IT-workers-to-get-work-visa.webp",
    category: "Work Visa & Migration",
    publishedAt: new Date("2023-06-20"),
  },
  {
    title: "10 Things to Know Before Studying in Germany",
    slug: "10-things-to-know-before-studying-in-germany",
    excerpt: "Planning your higher education journey in Germany? Here are 10 indispensable facts regarding semester fees, accommodation hunt, blocked accounts, and health insurance.",
    content: `<p>Preparing to study abroad in Germany requires diligent planning. Here are the top 10 things every aspiring student needs to know:</p>
    <ol>
      <li><strong>Tuition-Free Universities:</strong> Most public universities charge only a nominal semester contribution (€150 - €350) which covers public transit passes.</li>
      <li><strong>Blocked Account (Sperrkonto):</strong> International students must deposit required living expenses to satisfy student visa financial requirements.</li>
      <li><strong>Health Insurance:</strong> Mandatory statutory health insurance coverage is required for university enrollment.</li>
      <li><strong>Part-Time Work:</strong> International students can work 140 full days or 280 half days per calendar year.</li>
      <li><strong>Post-Study Work Visa:</strong> An 18-month job seeker visa is granted upon graduation.</li>
      <li><strong>Language:</strong> While hundreds of Master's courses are taught in English, learning basic German (A1-B1) significantly enriches your social integration and job prospects.</li>
      <li><strong>APS Certificate:</strong> Mandatory verification of Indian academic transcripts prior to visa submission.</li>
      <li><strong>Accommodation:</strong> Student dormitories (Studentenwerk) fill up fast; apply early!</li>
      <li><strong>City Registration (Anmeldung):</strong> Must be completed within 14 days of moving into an apartment.</li>
      <li><strong>13 Dreams Guidance:</strong> Our Bareilly and Khatima teams walk you through every step to ensure a smooth transition.</li>
    </ol>`,
    image: "https://13dreamsconsultants.com/img/blog/10-Things-to-Know-Before-Studying-in-Germany.webp",
